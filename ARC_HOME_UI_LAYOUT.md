...
- Card Content: Arena name, project name, X handle, creator count, time remaining, actions
...
- Card Content: Arena name, project name, X handle, start date and countdown
