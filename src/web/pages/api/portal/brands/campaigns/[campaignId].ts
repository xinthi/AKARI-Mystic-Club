...
export default async function handler(req: NextApiRequest, res: NextApiResponse<Response>) {
  ...
  const submissionsQuery = supabase
    ...
    .select('id, creator_profile_id, platform, post_url, status, submitted_at, like_count, reply_count, repost_count, view_count, x_tweet_id, verified_at, rejected_reason, used_campaign_link, matched_utm_link_id, twitter_fetch_error, twitter_fetch_at, qualified, qualification_reason, eligible, brand_attribution, post_quality_score, post_final_score')
    .eq('campaign_id', campaignId)
