/**
 * API Route: POST /api/portal/creator-manager/programs/[programId]/creators/[creatorProfileId]/status
 * 
...
export default async function handler(
  ...
  try {
    ...
    // Update creator status using creator_profile_id and program_id
    ...
    if (body.status === 'approved' || body.status === 'rejected') {
      ...
      await createNotification(supabase, creatorProfileId, notificationType, {
        programId,
