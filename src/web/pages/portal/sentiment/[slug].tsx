    ...
    <div className="relative flex-shrink-0">
      {url ? (
        <>
          ...
          />
          <div className={`hidden flex ${sizeClasses[size]} items-center justify-center rounded-full bg-gradient-to-br from-akari-primary/20 to-akari-accent/20 text-akari-primary font-semibold border border-akari-border`}>
            {name.charAt(0).toUpperCase()}
          </div>
        </>
      ) : (
        <div className={`flex ${sizeClasses[size]} items-center justify-center rounded-full bg-gradient-to-br from-akari-primary/20 to-akari-accent/20 text-akari-primary font-semibold border border-akari-border`}>
          {name.charAt(0).toUpperCase()}
        </div>
      )}
    </div>
